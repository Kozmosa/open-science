...
const pages = {
    pages: {
      ...
      workspaces: {
        ...
        availableForTasks: 'Available for new Tasks',
        notAvailableForTasks: 'Not available for new Tasks',
        cannotExecute: 'Execution is unavailable',
        unknownReason: 'No runtime evidence was provided',
        ...
        projectLinksDescription: 'A linked Workspace may still be unavailable for execution; runtime grants are evaluated separately.',
        primary: 'Primary',
        ...
        emptyDescription: 'Register an Environment path before creating executable Tasks.',
        noDescription: 'No description',
      },
      workspaceBrowser: {
