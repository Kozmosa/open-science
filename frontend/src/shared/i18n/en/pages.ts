...
const pages = {
    pages: {
      ...
      settings: {
        ...
        title: 'Settings',
        description:
          'Customize your OpenScience experience: default landing page, editor preferences, and project selections.',
        recoveryNotice:
        ...
        project: {
          ...
          description:
            'Active project selections stored locally in this browser.',
