...
const pages = {
    pages: {
      ...
      tasks: {
        ...
        createDescription:
          'Launch a task against a workspace and its runtime environment.',
        ...
        create: {
          ...
          derivedEnvironment: 'Derived from workspace',
          registerWorkspace: 'Register or link workspace',
          capabilityUnavailable: 'This capability is unavailable on the current backend.',
          capabilityLoading: 'Loading capability status...',
          taskExecutionMaintenance: 'Task execution is paused for maintenance.',
          taskDispatcherStale: 'The task dispatcher heartbeat is stale.',
          taskDispatcherUnavailable: 'No active task dispatcher is available.',
          overviewSnapshotUnavailable: 'The overview snapshot store is unavailable.',
        ...
        status: {
          ...
          stopped_by_project_archive: 'Stopped by Project archive',
          stopped_permission_revoked: 'Stopped: permission revoked',
          stopped_runtime_unknown: 'Stopped: runtime unknown',
        },
        ...
        reopenFailed: 'Failed to reopen task',
        renameTaskLabel: 'Task name',
        renameTaskHint: 'Click to rename task',
      ...
      workspaces: {
        ...
        registerTitle: 'Register a workspace',
        edit: 'Edit registry record',
        editTitle: 'Edit workspace',
        unregister: 'Unregister',
        unregisterTitle: 'Unregister workspace',
        unregisterDescription: 'This removes the registry record and Project links. It does not delete the directory or any files on disk.',
        consoleDescription: 'Manage task directories, runtime environments, and Project links in one place.',
        workspaceCount: '{{count}} total',
        newAction: 'New',
        searchLabel: 'Search Workspaces',
        searchPlaceholder: 'Search by name, path, or Environment',
        ...
        copy: 'Copy',
        unavailableReason: 'Unavailable because:',
        taskSummary: '{{active}} active / {{total}} total',
        ...
        projectLinksDescription: 'A linked Workspace may still be unavailable; runtime Environment access is evaluated separately.',
        primary: 'Primary',
        noProjectLinks: 'This Workspace is not linked to an active Project.',
        files: 'Browse files',
        terminal: 'Open terminal',
        context: 'Workspace context',
        optionalProject: 'Optional initial Project',
        noInitialProject: 'Register without a Project link',
        makePrimary: 'Make this the Project Primary Workspace',
        emptyTitle: 'No registered Workspaces',
        emptyDescription: 'Register an Environment path before creating Tasks.',
        noDescription: 'No description',
      },
      workspaceBrowser: {
