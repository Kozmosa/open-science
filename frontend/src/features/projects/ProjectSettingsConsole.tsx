...
export default function ProjectSettingsConsole({ project }: { project: DomainProjectProjection }) {
  ...
  const [memberRole, setMemberRole] = useState<DomainProjectMemberRole>('viewer');
