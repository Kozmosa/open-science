...
import { useTerminalFitScheduling } from '../hooks/useTerminalFitScheduling';
...
function TerminalSessionConsole({
  ...
  return (
    <section className="space-y-3 rounded-lg border border-[var(--border)] bg-[var(--bg-secondary)] p-4">
      ...
      <div
        ref={containerRef}
        className="openscience-terminal h-[480px] w-full overflow-hidden rounded-lg border border-[#1a1a2e] bg-[#0b1020]"
      />
    </section>
  );
}
