    ...
    pages: {
      ...
      settings: {
        ...
        codex: {
          ...
          updateWarning: 'This will overwrite the current installation. Existing configuration files (config.toml, auth.json) will be preserved.',
        },
        engine: {
      ...
      timeline: {
        ...
        noSessions: 'No sessions in this time range',
        session: 'Session',
    ...
    pages: {
      ...
      settings: {
        ...
        codex: {
          ...
          forceUpdate: '强制更新',
          updateTitle: '更新 {name}',
          updateWarning: '这将覆盖当前安装。现有配置文件（config.toml, auth.json）将被保留。',
        },
        engine: {
          claudeCode: 'Claude Code',
          claudeAgent: 'Claude Agent',
          codexAppServer: 'Codex 应用服务器',
        },
        defaultWorkspace: {
          title: '默认工作区',
