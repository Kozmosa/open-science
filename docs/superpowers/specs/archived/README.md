...
- 2026-08-01 Conversation Domain cutover：完成 Task/Attempt/RuntimeSession 到 Task/Turn/Item/Submission/Execution/Binding 的 persistence、application Interface、runtime、worker、HTTP、frontend、migration 与 compatibility cutover；长期 authority 已提升到 `PROJECT_BASIS.md` 和公开架构文档。
