...
> 本文第 13–15 节对“保留 attempt-scoped Codex runtime”的建议已被后续设计取代。OpenScience 现采用 Codex 的 Task/Thread、Turn、Item、steer、interrupt 语义，并使用 tenant/Environment-scoped 长驻 Codex App Server；历史设计见 [[superpowers/specs/archived/2026-07-17-codex-aligned-conversation-domain-design]] 与 [[superpowers/specs/archived/2026-07-17-engine-runtime-and-credential-injection-design]]。本文对 Breakwater 上游实现的事实性调研仍然有效。
