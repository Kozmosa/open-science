...
<CardGrid>
  <Card title="审计日志" href="/open-science/observability/audit-logs/">
    structlog JSON 审计事件、事件目录与日志格式。
  </Card>
  <Card title="Prometheus 指标" href="/open-science/observability/metrics/">
    计数器、直方图、仪表盘指标参考与 PromQL 查询。
  </Card>
  <Card title="监控栈" href="/open-science/observability/monitoring-stack/">
...
- [审计日志](/open-science/observability/audit-logs/) — 事件详情
- [Prometheus 指标](/open-science/observability/metrics/) — 指标参考
- [安全架构](/open-science/security/) — 安全配置
