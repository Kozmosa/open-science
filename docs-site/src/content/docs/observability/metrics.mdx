---
title: Prometheus 指标
description: AINRF Prometheus 指标参考 — 计数器、直方图、仪表盘与 PromQL 查询示例。
---
...
- [可观测性概览](/scholar-agent/observability/) — 审计事件目录
- [监控栈](/scholar-agent/observability/monitoring-stack/) — Grafana Dashboard 与告警
- [安全架构](/scholar-agent/security/) — 安全配置参考
