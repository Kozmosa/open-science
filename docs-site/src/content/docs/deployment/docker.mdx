...
三种 Docker Compose 文件均已内置 Prometheus + Grafana，详见 [监控栈](/open-science/observability/monitoring-stack/)。
...
- [部署概览](/open-science/deployment/) — 前置条件与安全检查清单
- [Kubernetes](/open-science/deployment/kubernetes/) — 生产集群部署
- [可观测性概览](/open-science/observability/) — 监控与审计
