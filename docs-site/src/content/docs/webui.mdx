---
title: WebUI 总览
description: AINRF 前端页面架构、路由表、技术栈与布局结构。
---
...
- [项目管理](/scholar-agent/projects/) — 项目 Canvas 详解
- [终端管理](/scholar-agent/terminal/) — 终端会话
- [认证与授权](/scholar-agent/auth/) — 登录与鉴权
- [系统设置](/scholar-agent/settings/) — 设置面板
